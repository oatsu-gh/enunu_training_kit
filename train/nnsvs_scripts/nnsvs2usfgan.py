...
def get_parser():
    ...
    parser.add_argument('--feature_type', type=str, default='world', help='Feature type')
    parser.add_argument('--relative_path', action='store_true', help='Use relative path')
    return parser
...
if __name__ == '__main__':
    ...
    if args.feature_type == 'world':
        ...
        usfgan_scaler = {
            'mcep': StandardScaler(scaler.mean_[0:60], scaler.var_[0:60], scaler.scale_[0:60]),
            'f0': StandardScaler(scaler.mean_[60:61], scaler.var_[60:61], scaler.scale_[60:61]),
            ...
            'cf0': StandardScaler(scaler.mean_[60:61], scaler.var_[60:61], scaler.scale_[60:61]),
            'codeap': StandardScaler(scaler.mean_[62:], scaler.var_[62:], scaler.scale_[62:]),
        }
