...
if [ ${stage} -le 2 ] && [ ${stop_stage} -ge 2 ]; then
    echo "========================================="
    echo "#                                       #"
    echo "#   stage 2: TRAIN time-lag model       #"
    echo "#                                       #"
    echo "========================================="
...
if [ ${stage} -le 3 ] && [ ${stop_stage} -ge 3 ]; then
    echo "========================================="
    echo "#                                       #"
    echo "#   stage 3: TRAIN duration model       #"
    echo "#                                       #"
    echo "========================================="
...
if [ ${stage} -le 4 ] && [ ${stop_stage} -ge 4 ]; then
    echo "========================================="
    echo "#                                       #"
    echo "#   stage 4: TRAIN acoustic model       #"
    echo "#                                       #"
    echo "========================================="
...
if [ ${stage} -le 8 ] && [ ${stop_stage} -ge 8 ]; then
    echo "============================================================="
    echo "#                                                           #"
    echo "#   stage 8: TRAIN post-filter                              #"
    echo "#                                                           #"
    echo "============================================================="
...
if [ ${stage} -le 10 ] && [ ${stop_stage} -ge 10 ]; then
    ...
    echo $dump_norm_dir/$train_set/in_vocoder
    mkdir -p $expdir/$vocoder_model
    cp -v $dump_norm_dir/in_vocoder*.npy $expdir/$vocoder_model
    xrun $PYTHON_EXE -m parallel_wavegan.bin.train --config conf/train_parallel_wavegan/${vocoder_model}.yaml \
...
if [ ${stage} -le 11 ] && [ ${stop_stage} -ge 11 ]; then
    echo "============================================================="
    echo "#                                                           #"
    echo "#   stage 11: TRAIN uSFGAN vocoder                          #"
    echo "#                                                           #"
    echo "============================================================="
...
if [ ${stage} -le 13 ] && [ ${stop_stage} -ge 13 ]; then
    echo "============================================================="
    echo "#                                                           #"
    echo "#   stage 13: TRAIN SiFi-GAN vocoder                        #"
    echo "#                                                           #"
    echo "============================================================="
...
if [ ${stage} -le 99 ] && [ ${stop_stage} -ge 99 ]; then
    ...
    #     exit 1
    # fi
    # ----- original NNSVS scripts until here -----------------------------------------------
    # ----- ETK modified from here ------------------------------------------------
    # Find settings needed for inference
    local_config_path=conf/prepare_features/acoustic/${acoustic_features}.yaml
    if [ -e $local_config_path ]; then
        relative_f0=$(grep relative_f0 $local_config_path | awk '{print $2}')
